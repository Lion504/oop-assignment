 ...
 * Now enhanced with database integration using DAO pattern and transaction storage
 */
public class CurrencyController {
     ...
     * Now loads currencies from database and saves transactions
     */
     ...
     * Now also saves the transaction to the database
     */
    private void convertCurrency() {
        try {
            ...
            saveTransactionToDatabase(fromCurrency, toCurrency, amount, result);
    ...
    /**
     * Save the currency conversion transaction to the database
     * @param sourceCurrency The currency we converted from
     * @param targetCurrency The currency we converted to
     * @param sourceAmount The original amount
     * @param targetAmount The converted amount
     */
    private void saveTransactionToDatabase(Currency sourceCurrency, Currency targetCurrency,
        ...
        try {
            ...
            // We don't show an error to the user because the conversion still worked
            // We just couldn't save it to history
        }
    }
